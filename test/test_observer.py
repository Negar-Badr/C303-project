...
class TestObserverPattern:
    ...
    def test_hunter_strategy_switches_on_flower_vs_rock(self):
        ...
        """
        hunter = Hunter(encounter_text="Caught ya!")
    ...
    def test_hunter_strategy_resets_on_lose(self):
        """
        Test that the hunter's movement strategy resets to RandomMovement on losing.
        """
        hunter = Hunter(encounter_text="I caught you!!")
        self.gsm.add_observer(hunter)

        self.gsm.notify_observers("LOSE")
